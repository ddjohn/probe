...
public class EncodeAndMux {
    private static final String TAG = EncodeAndMux.class.getCanonicalName();
    ...
    public void testEncodeVideoToMp4() {
        ...
        try {
            ...
            for (int i = 0; i < NUM_FRAMES; i++) {
                ...
                Log.e(TAG, "sending frame " + i + " to encoder");
    ...
    private void drainEncoder(boolean endOfStream) {
        ...
        Log.e(TAG, "drainEncoder(" + endOfStream + ")");
